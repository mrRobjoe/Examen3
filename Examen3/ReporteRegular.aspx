<%@ Page Title="" Language="C#" MasterPageFile="~/MenuRegular.Master" AutoEventWireup="true" CodeBehind="ReporteRegular.aspx.cs" Inherits="Examen3.WebForm10" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div>
        <p>Reporte artículos</p>
    </div>
    ...
    <div>
        <p>Reporte fondos</p>
        <p>
            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="codigoArticulo" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
                <AlternatingRowStyle BackColor="White" />
                <Columns>
